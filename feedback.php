...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $product_id = intval($_POST['product_id']); // Lấy product_id từ form gửi lên
    $sao = intval($_POST['sao']);
    $noi_dung = mysqli_real_escape_string($conn, $_POST['noi_dung']);

    // Chèn dữ liệu vào bảng feedback, có thêm product_id
    $sql = "INSERT INTO feedback (user_id, product_id, sao, noi_dung, ngay) 
            VALUES ($user_id, $product_id, $sao, '$noi_dung', NOW())";
